...
# Start the service
ENTRYPOINT  java  -Dcom.mojang.eula.agree=true -jar -Xms512M -Xmx1008M spigot-1.11.2.jar nogui --world-dir /data    --config /data/config/server.properties   --bukkit-settings /data/config/bukkit.yml  --commands-settings /data/config/commands.yml  --spigot-settings /data/config/spigot.yml 
